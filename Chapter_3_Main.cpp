...
*/
/*PAGE 86 EXERCISE 7
Step 1: Get three words from user input
Step 2: Print all the words entered
Step 3: Take first word and first character in it.
Step 4: Find the ASCII value of that character and print it.
Step 5: Convert the ASCII value to integer, store it in a variable and print it.
Step 6: Take second word and repeat steps 4 and 5.
Step 7: Take third word and repeat steps 4 and 5.
Step 8: Compare the three integer values obtained from steps 5, 6 and 7.
Step 9: Use previous program to arrange the integer values in ascending order.
Step 10: Compare the first character of the each word with first integer. If it matches then print that word first.
Step 11: Compare the first character of the each word with second integer. If it matches then print that word second.
Step 12: Compare the first character of the each word with third integer. If it matches then print that word third.
...
int main()
{
    ...
    cout<<"The first letter of the first word is: "<<word1[0]<<"\n";
    char first_char_word1 = word1[0];
    int ascii_value_word1 = int(first_char_word1);

    cout<<"The ASCII value of the first letter of the "<<word1<<" is: "<<ascii_value_word1<<"\n";

    cout<<"The first letter of the second word is: "<<word2[0]<<"\n";
    char first_char_word2 = word2[0];   
    int ascii_value_word2 = int(first_char_word2);
    cout<<"The ASCII value of the first letter of the "<<word2<<" is: "<<ascii_value_word2<<"\n";

    cout<<"The first letter of the third word is: "<<word3[0]<<"\n";
    char first_char_word3 = word3[0];
    int ascii_value_word3 = int(first_char_word3);
    cout<<"The ASCII value of the first letter of the "<<word3<<" is: "<<ascii_value_word3<<"\n";

    int num1 = ascii_value_word1;
    int num2 = ascii_value_word2;   
    int num3 = ascii_value_word3;
   ...
   else //num2<num1 Case 3, 5, 6
   {
    ...
    if(small == ascii_value_word1)
    {
        first_word = word1;
    }
    else if(small == ascii_value_word2)
    {
        first_word = word2;
    }
    else if(small == ascii_value_word3)
    {
        first_word = word3;
        
    }

    if(medium == ascii_value_word1)
    {
        second_word = word1;
    }
    else if(medium == ascii_value_word2)
    {
        second_word = word2;
    }
    else if(medium == ascii_value_word3)
    {
        second_word = word3;
        
    }

    if(large == ascii_value_word1)
    {
        third_word = word1;
    }
    else if(large == ascii_value_word2)
    {
        third_word = word2;
    }
    else if(large == ascii_value_word3)
    {
        third_word = word3;
    ...
    cout<<"The ascending order of words is "<<first_word<<" "<<second_word<<" "<<third_word<<"\n";
...
Case 2: 1 3 2--> num1<num2, num3<num2, num1<num3 --> num1<num3<num2 --> 1<2<3 ---> 
Case 3: 2 1 3--> num2<num1, num2<num3, num1<num3 --> num2<num1<num3 --> 1<2<3 ---> 
Case 4: 2 3 1--> num1<num2, num3<num2, num3<num1 --> num3<num1<num2 --> 1<2<3 ---> 
Case 5: 3 1 2--> num2<num1, num2<num3, num3<num1 --> num2<num3<num1 --> 1<2<3 ---> 
Case 6: 3 2 1--> num2<num1, num3<num2, num3<num1 --> num3<num2<num1 --> 1<2<3 ---> 
